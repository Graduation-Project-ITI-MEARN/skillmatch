...
export const selectTriggerVariants = cva(
  mergeClasses(
    ...
    // ADD EXPLICIT BACKGROUND COLOR HERE
    'bg-white',
...
export const selectContentVariants = cva(
  // ADD EXPLICIT BACKGROUND AND Z-INDEX
  mergeClasses(
    'min-w-full scrollbar-hide overflow-y-auto rounded-md border border-gray-200',
    'bg-white',
    'text-gray-900',
    'shadow-sm animate-in fade-in-0 zoom-in-95',
    // Use inline style for z-index since z-9999 might not exist in Tailwind
    'relative'
  ),
  {
    variants: {},
...
export const selectItemVariants = cva(
  mergeClasses(
    'relative flex min-w-full cursor-pointer text-nowrap items-center gap-2 rounded-sm mb-0.5',
    'outline-hidden select-none',
    // ADD EXPLICIT COLORS FOR ITEMS
    'text-gray-900 ',
    'hover:bg-gray-100 ',
    'hover:text-gray-900 ',
    ...
    'data-disabled:hover:bg-transparent data-disabled:hover:text-current',
