...
export class Dashboard implements OnInit {
  ...
  ngOnInit() {
    ...
    this.userName =
      this.currentUserData?.name || this.currentUserData?.email?.split('@')[0] || 'User';
    ...
    switch (type) {
      case 'candidate':
        ...
        this.tabs = [
          ...
          {
            label: 'My Portfolio',
            route: '/dashboard/candidate/browse',
      ...
      case 'challenger':
        ...
        this.tabs = [
          ...
          {
            label: 'Create New',
            route: '/dashboard/challenger/create-bounty',
            icon: 'M12 4v16m8-8H4',
            roles: ['challenger'],
          },
        ];
