...
// --- YOUR EXACT IMPORTS ---
import { AngledContainer, AngledCard } from "@/app/components/ui/AngledSplitCard";
  ...
  return (
    <main className="min-h-screen flex flex-col bg-white overflow-x-hidden">
      ...
      <section className="pt-24 pb-16 px-6">
        <div className="max-w-7xl mx-auto">
           ...
           <div className="text-center mb-16">
              <h1 className="text-5xl md:text-7xl font-serif text-[var(--color-black)] leading-tight mb-8">
                 {t("Hero.headline")} <br />
           ...
           <div className="h-[500px]">
             ...
             <AngledContainer mode="layout" gap="gap-4 md:gap-8" overlap={false}>
                 ...
                 <AnimatePresence mode="wait">
                    ...
                    >
                       <h2 className="text-3xl md:text-4xl font-serif mb-6 leading-tight text-black">
                          {isHiring ? t("Hero.companies.title") : t("Hero.candidates.title")}
                       </h2>
                       <p className="text-gray-600 mb-8 leading-relaxed text-base md:text-lg">
                          {isHiring ? t("Hero.companies.desc") : t("Hero.candidates.desc")}
                       </p>
                       <button 
                       ...
                       >
                          {isHiring ? t("Hero.companies.link") : t("Hero.candidates.link")} 
                          <ArrowRight size={24} />
                       </button>
                    </motion.div>
                 </AnimatePresence>
               ...
               >
                  <AnimatePresence mode="wait">
                     <motion.div
                        key={isHiring ? "companies-img" : "candidates-img"}
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                     ...
                     >
                        ...
                        <div className="relative z-10 w-3/4 h-3/4 flex items-center justify-center">
                            <img 
                               src={isHiring ? "/images/landing/hero-globe.png" : "/images/landing/hero-candidate.png"} 
                               alt="Visual"
      ...
      <section className="relative py-24 overflow-hidden text-center">
         <div className="absolute inset-0 bg-gradient-to-br from-[#a87866] via-[#946b78] to-[#6a6b85] z-0">
