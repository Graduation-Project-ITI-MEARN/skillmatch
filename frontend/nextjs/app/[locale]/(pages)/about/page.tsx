...
export default function AboutPage() {
   ...
   return (
      <div className="min-h-screen  font-sans text-black p-8 pb-20">
         {/* 1. Header Section */}
         ...
         {/* Dark Container */}
         <div className="w-full rounded-[40px] overflow-hidden relative min-h-[600px] flex flex-col items-center justify-center py-16 px-6 bg-[url('/images/background-3.svg')] mb-24">
