...
const MOCK_CHALLENGES: Challenge[] = [
   ...
   {
      id: "3",
      title: "Graphic Design For Ad Campaign",
      company: "GRAVITY",
      location: "Morocco",
      deadline: "2025-10-07",
      category: "Design",
...
export default function ChallengesPage() {
   ...
   const filteredData = MOCK_CHALLENGES.filter(
      (item) =>
      ...
      <div className="bg-white min-h-screen pb-20 font-sans text-black">
         <div className="text-center py-24 px-6">
            ...
            <p className="max-w-2xl mx-auto text-gray-500 text-lg">
               Join world-class challenges and showcase your skills to top
               companies.
            </p>
         </div>
         ...
         <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row gap-16">
            ...
            <aside className="w-full md:w-64 space-y-12">
               ...
               <div>
                  ...
                  <select
                     className="w-full p-3 bg-gray rounded-xl outline-none font-bold text-sm"
            ...
            <div className="flex-1">
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                  {currentItems.map((item) => (
                     <ClippedCard key={item.id} challenge={item} />
                  ))}
               </div>
               ...
               <div className="flex justify-center items-center gap-6 mt-20">
                  <button
                     ...
                     disabled={page === 1}
                     className="text-2xl opacity-30 disabled:hover:opacity-30 hover:opacity-100 transition-opacity">
                     ←
                  </button>
