                  ...
                  {activeTab === section && (
                    ...
                    >
                      <ul className="pt-6 space-y-4">
                        {Array.from({ length: getPointsCount(section) }).map((_, i) => (
                           <li key={i} className="flex items-start gap-3 text-[var(--color-dark-gray)]">
                              <CheckCircle2 size={24} className="text-[var(--color-black)] shrink-0 mt-0.5" />
