...
export default function ClippedCard({ challenge }: { challenge: Challenge }) {
   const style =
      categoryStyles[challenge.category] || "bg-gray-100 text-gray-600";
   ...
   return (
      <div className="relative group h-full">
         ...
         <div
            ...
            style={{
               clipPath:
                  "polygon(0 0, 100% 0, 100% 85%, 75% 85%, 70% 100%, 0 100%)",
            }}>
            <h3 className="text-3xl font-serif mb-4 leading-tight text-black capitalize">
               {challenge.title}
            </h3>
            <p className="text-[11px] font-bold text-gray-500 uppercase tracking-widest mb-6">
               {challenge.company || "Company"} -{" "}
               {challenge.location || "Remote"} <br />
